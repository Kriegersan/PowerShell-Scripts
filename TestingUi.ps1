...
<Window x:Class="WpfApplication2.MainWindow"
        ...
        mc:Ignorable="d"
        Title="Special K's Awesome Tool" Height="464.992" Width="707.344" Topmost="True">
    <Grid Margin="0,0,45,0">
        <Image x:Name="image" HorizontalAlignment="Left" Height="173" Margin="56,28,0,0" VerticalAlignment="Top" Width="160" Source="C:\Users\Public\Pictures\Sample Pictures\Lighthouse.jpg"/>
        <TextBlock x:Name="textBlock" HorizontalAlignment="Left" Height="100" Margin="280,28,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="282" FontSize="16"><Run Text="Use this tool to find out all sorts of useful disk information, and also to get rich input from your scripts and tools"/><InlineUIContainer>
                <TextBlock x:Name="textBlock1" TextWrapping="Wrap" Text="TextBlock"/>
            </InlineUIContainer></TextBlock>
        <Button x:Name="button" Content="Get-DiskInfo" HorizontalAlignment="Left" Height="35" Margin="436,166,0,0" VerticalAlignment="Top" Width="145" FontSize="18.667"/>
        ...
        <Label x:Name="label" Content="ComputerName" HorizontalAlignment="Left" Height="46" Margin="56,162,0,0" VerticalAlignment="Top" Width="138" FontSize="16"/>
        <ListView HorizontalAlignment="Left" Height="191" Margin="56,222,0,0" VerticalAlignment="Top" Width="525">
            <ListView.View>
                <GridView>
